...
// Pitch Switch: special procedure for changing the printwheel pitch
// on-the-fly: Includes inducing Power-on-Reset
#define QWERTY_PITCH_SWITCH_10P         (0x0001)
#define QWERTY_PITCH_SWITCH_12P         (0x0002)
#define QWERTY_PITCH_SWITCH_15P         (0x0004)
#define QWERTY_PITCH_SWITCH_PSP         (0x0008)
// control codes pitch related, but can be used on their own
#define QWERTY_PITCH_SWITCH_LANG        (0x0010)
#define QWERTY_PITCH_SWITCH_STOP        (0x0020)
#define QWERTY_PITCH_SWITCH_SENSOR_TEST (0x0040)
