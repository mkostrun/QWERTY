...
#error "This File is Intended only for Panasonic RK-T55 Typewriter"
#endif

/* for panasonic, sense being 0 is not valid sense, so this works */
...
#define KEYBOARD_SOURCE_MASK  (0x00F0)
...
//
// special combinations of Source/Drain
//
...
//  0 - mode typewriter / MODE 0
//  1 - center
//  2 - right flush
//  3 - full            / MODE 2 uses word wrap to limit line length, no LFs
